    ...
    <div className="an-root">
        ...
        <div className="an-hero-inner">
          <div>
            ...
            <div className="an-hero-actions">
              <a href="shop.html" className="an-btn-primary">Acquista i biglietti →</a>
      ...
      <section id="pacchetti" className="an-pacchetti">
        ...
        <div className="an-pack-hero an-pack featured">
          ...
          <div className="an-pack-hero-right">
            ...
            <a href="shop.html" className="an-pack-cta">Acquista →</a>
          </div>
        </div>
      ...
      <section className="an-cta-final">
        <div className="an-cta-final-inner">
          ...
          <a href="shop.html" className="an-cta-final-btn">Acquista i biglietti →</a>
        </div>
      </section>
          ...
          <React.Fragment>
            ...
            <div className="an-modal open visible">
              ...
              <div className="an-modal-body">
                ...
                <a href="shop.html" className="an-mod-cta">Acquista il biglietto →</a>
              </div>
            </div>
          </React.Fragment>
        );
